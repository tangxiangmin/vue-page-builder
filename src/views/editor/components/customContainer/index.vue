<template>
  <draggable :class="{'drag-area':true,'page-root':root}" v-bind="$attrs" :list="list" :options="dragOptions" ghost-class="ghost" @add="addWidget">
    <abstractContainer
    ...
    >
      <CustomContainer :list="item.children" :disabled="!item.config.nested" :style="item.config.style" />
    </abstractContainer>
  </draggable>
</template>
<script>
